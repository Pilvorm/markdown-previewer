...
class App extends React.Component {
  ...
  render() {
    ...
    const themeClass = this.state.lightTheme ? ['light', 'dark_mode'] : ['dark', 'light_mode'];
  ...
  return (
    <header>
      ...
      <div className="action">
        <motion.span className="material-symbols-outlined" onClick={props.onClick}
...
const Toolbar = (props) => {
  return (
    <div className="toolbar">
      ...
      {props.text}
      <span className="material-symbols-outlined cursor-pointer sizing" onClick={props.onClick}>{props.sizing}</span>
    </div>
  );
};
